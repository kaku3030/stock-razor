...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'research-validation', labelKey: 'layout.nav.researchValidation', to: '/research-validation', icon: FlaskConical },
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      >
        ...
        {!collapsed ? (
          <p className={cn('min-w-0 truncate font-semibold text-foreground', isRail ? 'text-[0.95rem] leading-none' : 'text-sm')}>Stock Razor</p>
        ) : null}
      </div>
